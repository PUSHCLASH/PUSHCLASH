...
# ---------- Frontend (simple IKIGAI text badge) ----------
FRONTEND_HTML = """
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins', sans-serif; }
    ...
    /* SIMPLE IKIGAI BADGE – guaranteed to appear */
    .ceo-badge {
      position: fixed;
      top: 15px;
      right: 15px;
      ...
      padding: 8px 14px;
      border-radius: 20px;
      box-shadow: 0 0 15px rgba(255,69,0,0.5), 0 0 25px rgba(0,191,255,0.5);
      cursor: pointer;
      animation: badgeGlow 2s infinite;
    }
    @keyframes badgeGlow {
      0% { box-shadow: 0 0 10px #ff4500, 0 0 20px #00bfff; }
      50% { box-shadow: 0 0 25px #ff8c00, 0 0 40px #00ffff; }
      100% { box-shadow: 0 0 10px #ff4500, 0 0 20px #00bfff; }
    }
...
<body>
  ...
  <!-- SIMPLE IKIGAI BADGE -->
  <span class="ceo-badge" onclick="document.getElementById('ceoModal').classList.add('active')">IKIGAI</span>
