...
def init_db():
    ...
    try:
        ...
        # log error but continue; endpoints defensively handle missing columns
...
# ---------- Frontend ----------
# NOTE: This FRONTEND_HTML includes the improved rep-counting JS already discussed earlier.
# Paste your full HTML/JS here exactly (I include the full page below).
FRONTEND_HTML = r"""
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="app-container" id="appContainer">
  ...
  <!-- rest of frontend screens (dashboard, challenge, stats, leaderboard) identical to previous version -->
  <!-- The challenge screen includes the improved pose/rep counting JS loaded below. -->
